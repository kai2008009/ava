<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Select.ascx.cs" Inherits="AVA.ResourcesPlatform.AdminUI.Pub.ApplicationTimeSetting.Select1" %>
...
break;
    ...
    <tr class="trout">
        ...
        <td class="wd1 select" onclick="Select(&quot;<%= item.Guid.ToString(null).ToScriptTag()%>&quot;,&quot;<%= item.StartTime.ToString(null).ToScriptTag() %>&quot;);">
        </td>
        <%
            foreach (var field in this.Fields)
            {
