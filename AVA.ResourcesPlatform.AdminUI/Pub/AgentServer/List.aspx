<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="AVA.ResourcesPlatform.AdminUI.Pub.AgentServer.List" %>
                ...
                <div id="dvToolbar_inbox" class="g-toolbar">
                    <div class="btngrp">
                        <div style="margin-top: 5px;">
                            ...
                            <%= new HtmlHidden("$ExpressionKey", null)%>
                            <%= new HtmlHidden("$QueryType", (int)Z.Core.NHibernateCore.Search.QueryTypeEnum.Like)%>
                            <%= new HtmlText("$FieldValue", null) { Width = 180 }%>
                            <%= new HtmlHidden("$RightParenthesis", (int)Z.Core.NHibernateCore.Search.QueryParenthesisEnum.None)%>
                            <%= new HtmlHidden("$LogicType", (int)Z.Core.NHibernateCore.Search.LogicTypeEnum.AND)%>
                            <%= new HtmlHidden("$IgnoreEmpty", "1")%>
                    ...
                    <div class="btngrp btngrp-ext">
                        <div class="btngrp">
                            ...
                            <div class="btn btn-dft btn-dft-gr btn-dft-pd" title="" onclick="GoBatchDelete()">
                                <span>
            ...
            <div class="gSys-inner-dict">
                ...
                <div class="result bdr-c-mid">
                    <div class="inside">
                        ...
                        <ul id="ulViewDefine">
                            <%
                                Type t = typeof(AVA.ResourcesPlatform.AdminUI.Pub.AgentServer.List1);
                                var list = UserControlDefine.GetListViewDefine(UserCode, t.FullName, AVA.ResourcesPlatform.AdminUI.Pub.AgentServer.List1.LISTRPT);
...
<script type="text/javascript">
    ...
    function Search(send) {
        ...
        Global.UserControl("/Pub/AgentServer/List", params, send, function (result) {
    ...
    function Delete(send) {
        ...
        AgentServerAjax.Delete(key, send, function () {
            Search();
        });
    };
    ...
    function BatchDelete(send, key) {
        AgentServerAjax.BatchDelete(key, null, function () {
            Search();
        });
    };
</script>
